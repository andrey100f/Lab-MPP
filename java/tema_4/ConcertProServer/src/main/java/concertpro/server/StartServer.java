...
public class StartServer {
    public static void main(String[] args) {
        ...
        ISpectacleRepository spectacleRepository = new SpectacleDbRepository(serverProperties);
        Validator<Order> orderValidator = new OrderValidator();
        IOrderRepository orderRepository = new OrderDbRepository(serverProperties, orderValidator);
